 ...
 */
final class Version20210531122350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, society VARCHAR(255) NOT NULL, activity VARCHAR(255) NOT NULL, contact_name VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, contact_number INT NOT NULL, contact_email VARCHAR(255) NOT NULL, note VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
