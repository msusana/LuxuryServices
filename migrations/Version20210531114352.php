 ...
 */
final class Version20210531114352 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE date_created date_created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
    }
}
